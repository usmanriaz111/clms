    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                ...
                <h4 class="header-title mb-3"><?php echo get_phrase('video_edit_form'); ?></h4>

                <form class="required-form" action="<?php echo site_url('admin/videos/edit/'.$user_id); ?>" enctype="multipart/form-data" method="post">
