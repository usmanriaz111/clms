	    ...
	    <div class="card">
	        <div class="card-body">
	            ...
	            <div class="chat-conversation">
	                ...
	                <form method="post" action="<?php echo site_url('institute/message/send_reply/'.$current_message_thread_code); ?>" class="needs-validation" novalidate name="chat-form" id="chat-form">
	                    <div class="row">
	                        <div class="col">
