        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="" action="<?php echo site_url('institute/amazons3_setting/edit/'.$settings['id']); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <?php } else{ ?>
                        <form class="" action="<?php echo site_url('institute/amazons3_setting/add'); ?>" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            <label>AWS Access Key</label>
