        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                ...
                <div class="mail-sidebar-row visible-xs">
                    <a href="<?php echo site_url('institute/message/message_new');?>" class="btn btn-success btn-block">
                ...
                <ul class="navbar-nav">
                    ...
                    foreach($message_threads as $row):
                        ...
                        ?>
                        <li class="nav-item">
                            <a class="text-left mb-1 btn btn-light d-block <?php if (isset($current_message_thread_code) && $current_message_thread_code == $row['message_thread_code'])echo 'active';?>" href="<?php echo site_url('institute/message/message_read/' . $row['message_thread_code']);?>">

                                <?php
                                    $user_details = $this->db->get_where('users' , array('id' => $user_to_show_id))->row_array();
                                    echo $user_details['first_name'].' '.$user_details['last_name'];
                                ?>
                                <!-- <span class="badge badge-light pull-right" style="color:#aaa;"><?php echo $user_details['role_id'] == 1 ? get_phrase('institute') : get_phrase('student') ;?></span> -->
