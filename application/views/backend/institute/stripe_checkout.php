        ...
        <!-- <img src="<?php echo base_url().'uploads/system/logo-light.png'; ?>" width="15%;" style="opacity: 0.05;" id="application-logo"> -->
            ...
            <form method="post"
              <?php if($payment_request == 'true'): ?>
                action="<?php echo site_url('institute/stripe_payment/' . $user_details[0]['id'].'/'.$amount_to_pay.'/true');?>"
              <?php else: ?>
                action="<?php echo site_url('institute/stripe_payment/' . $user_details[0]['id'].'/'.$amount_to_pay);?>"
              <?php endif; ?>
            >
              <label>
