              ...
              <div class="card-deck mb-3 text-center">
                <?php foreach ($plans as $key => $plan) { ?>
                  <div class="card mb-4 box-shadow">
                    ...
                    <div class="card-body">
                      <h1 class="card-title pricing-card-title"><?php echo $plan['price']?> <small class="text-muted">/ mo</small></h1>
                      ...
                      <form action="<?php echo site_url('institute/plan_price'); ?>" method="post">
                        ...
                        <button class = "btn btn-success" type="submit" name="button"><?php echo get_phrase('buy_now'); ?></button>
                      </form>
