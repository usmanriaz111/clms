    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                ...
                <a href = "<?php echo site_url('Institute/import_students/class_id/'.$class_id); ?>" class="btn btn-outline-primary btn-rounded alignToTitle mr-4"><i class="mdi mdi-plus"></i><?php echo get_phrase('important_student'); ?></a>
            </h4>
            </div> <!-- end card body-->
        </div> <!-- end card -->
    </div><!-- end col-->
                              ...
                              <td>
                                  <div class="dropright dropright">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="<?php echo site_url('institute/user_form/edit_user_form/'.$user['id']) ?>"><?php echo get_phrase('edit'); ?></a></li>
                                        <li><a class="dropdown-item" href="#" onclick="confirm_modal('<?php echo site_url('institute/users/delete/'.$user['id']); ?>');"><?php echo get_phrase('delete'); ?></a></li>
                                    </ul>
                                </div>
                              </td>
                          </tr>
