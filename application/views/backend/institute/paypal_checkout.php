...
<body>
  ...
  <div class="package-details">
    <strong><?php echo get_phrase('institute_name');?> | <?php echo $user_details['first_name'].' '.$user_details['last_name'];?></strong> <br>
  ...
  paypal.Button.render({
    ...
    onAuthorize: function(data, actions) {
      ...
      return actions.payment.execute().then(function() {
        ...
        var redirectUrl = '<?php echo site_url('institute/paypal_payment/'.$user_details['id'].'/'.$amount_to_pay);?>'+'/'+data.paymentID+'/'+data.paymentToken+'/'+data.payerID;
